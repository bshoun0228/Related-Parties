...
ln_nonmatch_series = pd.Series([i for i in non_matches['LOAN_NAME'].unique() if i not in matches['LOAN_NAME'].unique()],
...
matches = matches[
    ['RELATED_PARTY_NAME', 'LOAN_NAME', 'LOAN_BASE', 'RELATED_PARTY_BASE', 'RATIO_BASE', 'RATIO_ORDER', 'RATIO_FULL',
     'ACCOUNTS']]
